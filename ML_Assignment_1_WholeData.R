...
(glmnet_mse_basic_march <- round(mean((test_set_march_basic$V281 - test)^2),2))
...
(result_glmnet <- data.frame("Metric" = c("MSE_TEST_FEB","MSE_TEST_MARCH"),
                         "BASIC" = c(glmnet_mse_basic_feb,glmnet_mse_basic_march),
                         "TEXTUAL"= c(glmnet_mse_textual_feb,glmnet_mse_textual_march)))
